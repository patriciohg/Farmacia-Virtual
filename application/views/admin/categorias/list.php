                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="<?php echo base_url();?>Mantenimiento/Categorias/edit/<?php echo $categoria->id; ?>" class="btn btn-warning"><span class="fa fa-pencil-alt "></span></a>
                                                            <a href="<?php echo base_url();?>Mantenimiento/Categorias/delete/<?php echo $categoria->id?>" class="btn btn-danger btn-remove"><span class="fa fa-trash-alt "></span></a>
